...
const HugrBrainFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
export class HugrBrain {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(HugrBrain.prototype);
        obj.__wbg_ptr = ptr;
        HugrBrainFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        HugrBrainFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_hugrbrain_free(ptr, 0);
    }
    /**
     ...
     */
    inflightLen() {
        const ret = wasm.hugrbrain_inflightLen(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    static withDefaultPolicy() {
        const ret = wasm.hugrbrain_withDefaultPolicy();
    ...
    constructor(policy_json) {
        try {
            ...
            wasm.hugrbrain_new(retptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
            ...
            this.__wbg_ptr = r0 >>> 0;
            HugrBrainFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
    ...
    poll() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.hugrbrain_poll(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
    ...
    submit(event_json) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.hugrbrain_submit(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    logJson() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.hugrbrain_logJson(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('hugr_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
