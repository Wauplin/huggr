//! An example **third-party** Hugr plugin (ROADMAP Phase 5).
//!
//! This is a standalone program in its own crate that depends on *nothing* from
//! Hugr — only `serde_json`. It speaks the documented plugin protocol over
...
//! `hugr_plugin_abi::SubprocessPlugin` and surfaces its tools as ordinary
